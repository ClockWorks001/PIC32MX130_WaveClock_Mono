...
//#define ROM_CHAR (rom char far const *)	//"Warning [2066] type qualifier mismatch in assignment"の対策
//// ==>http://avr.paslog.jp/article/1282371.html
enum eUSART_CMND {
	eUSART_CMND_Wait,
	eUSART_CMND_Exec,
	eUSART_CMND_Esc,
...
int xput_busy (void);					//for xprintf
